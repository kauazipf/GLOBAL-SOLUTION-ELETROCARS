  ...
  return (
    <div className="flex items-center justify-center m-16">
      <div className="w-[550px] h-[350px] bg-gradient-to-t from-laranjaLogo to-gray-300 rounded-lg p-12 text-justify m-20">
        ...
        <br />
        <p className="text-xl font-semibold">Utilizando de um sistema simples integrado a um site, os clientes poderão alugar os carros elétricos por tempo indeterminado, pagando assim pela energia utilizada e pelo serviço de aluguel.</p>
      </div>
    </div>
  );
}
